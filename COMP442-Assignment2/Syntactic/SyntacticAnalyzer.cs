...
namespace COMP442_Assignment2.Syntactic
{
    class SyntacticAnalyzer
    {
        ...
        public SyntacticAnalyzer()
        {
            ...
            Production funcBodyList = new Production("funcBodyList", new List<Token> { TokenList.IntRes, TokenList.FloatRes,  TokenList.Identifier, TokenList.Epsilon}, new List<Token> { TokenList.CloseCurlyBracket});
            ...
            Production varDecl = new Production("varDecl", new List<Token> { TokenList.SemiColon, TokenList.Epsilon, TokenList.OpenSquareBracket}, new List<Token> { TokenList.IntRes, TokenList.FloatRes, TokenList.Identifier, TokenList.CloseCurlyBracket});
